...
class Settings(BaseSettings):
    ...
    max_portfolio_exposure_pct: float = Field(default=0.30, alias="MAX_PORTFOLIO_EXPOSURE_PCT")
    max_single_exposure_pct: float = Field(default=0.08, alias="MAX_SINGLE_EXPOSURE_PCT")
    max_risk_per_trade_pct: float = Field(default=0.01, alias="MAX_RISK_PER_TRADE_PCT")
    ...
    max_kelly_fraction: float = Field(default=0.25, alias="MAX_KELLY_FRACTION")
    min_trades_for_kelly: int = Field(default=30, alias="MIN_TRADES_FOR_KELLY")

    # ── Exit Rules ──────────────────────────────────────────────────────────
    stop_loss_pct: float = Field(default=-18.0, alias="STOP_LOSS_PCT")
    trailing_stop_activate_pct: float = Field(default=15.0, alias="TRAILING_STOP_ACTIVATE_PCT")
    trailing_stop_distance_pct: float = Field(default=8.0, alias="TRAILING_STOP_DISTANCE_PCT")
    tier1_r_multiple: float = Field(default=2.0, alias="TIER1_R_MULTIPLE")
    tier1_exit_pct: float = Field(default=0.25, alias="TIER1_EXIT_PCT")
    tier2_r_multiple: float = Field(default=5.0, alias="TIER2_R_MULTIPLE")
    ...
    time_exit_hours: float = Field(default=4.0, alias="TIME_EXIT_HOURS")
    max_sell_retries: int = Field(default=3, alias="MAX_SELL_RETRIES")
    momentum_recheck_interval_minutes: int = Field(default=5, alias="MOMENTUM_RECHECK_INTERVAL_MINUTES")
    ...
    mutator_min_score_floor: float = Field(default=15.0, alias="MUTATOR_MIN_SCORE_FLOOR")
